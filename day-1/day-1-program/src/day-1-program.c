/*
 ============================================================================
 Name        : 	day-1-program.c
 Author      : 	Stefan Gojković
 Version     :
 Copyright   :
 Description : 	У датотеци program.c дат је програм који задати низ најпре
 	 	 	 	уређује у нерастућем редоследу, а онда исписује на екран
 	 	 	 	елементе уређеног низа докле год су већи од вредности задате
 	 	 	 	симболом TRESHOLD. Програм уз елементе низа исписује и индексе
 	 	 	 	које су елементи имали у почетном низу. Разумети програм.
 	 	 	 	Проверити да ли ради исправно. Која функција не ради исправно?
 	 	 	 	Ставити тачку прекида на почетак те функције. Корак по корак
 	 	 	 	извршавати функцију и пратити вредности. Уочити где се грешка
 	 	 	 	дешава и отклонити је. Поново проверити програм.
 ============================================================================
 */
